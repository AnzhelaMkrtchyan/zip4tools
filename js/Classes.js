...
export function drawProduct(data, coordinates, circle) {
  ...
  flyDiv.innerHTML = `
    ...
    <input type="text" class="title" value="${data.data.title}" placeholder="Title" />
		<input type="text" class="price" value="${data.data.price}" placeholder="price" />
    <div class="btn-group">
  ...
  const titleInp = flyDiv.querySelector(".title");
